...
namespace ViewPort.Functions
{
    public class Func
    {
        public static void SearchJPG_inZip(string FilePath, List<ImageListInfo> ImageDatabase, List<string> All_LotID_List, List<string> All_VerifyDF_List,  List<Tuple<string, int>> All_Equipment_DF_List)
        {
